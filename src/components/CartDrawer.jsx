              ...
              {cart.length === 0 ? (
                ...
                cart.map((item) => (
                  <div key={item.id} className="pt-4 first:pt-0 flex gap-3 sm:gap-4">
                    {/* Product Thumbnail */}
                    <div className="w-18 sm:w-20 h-22 sm:h-24 rounded-none bg-white/10 overflow-hidden shrink-0 border border-white/20 relative shadow-sm">
                      <img
                        src={item.image}
                        alt={item.name}
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                      <div>
                        <div className="flex justify-between items-start gap-2">
                          <h3
                            className="text-xs sm:text-[13px] uppercase tracking-wide font-medium text-white hover:text-white/80 transition-colors cursor-pointer leading-snug"
                          ...
                          <button
                            ...
                            className="text-white/70 hover:text-red-200 transition-colors p-1"
                        ...
                        <div className="flex flex-wrap items-center gap-1.5 mt-1 text-[10px] uppercase text-white/80">
                          {item.style && (
                            <span className="bg-white/20 text-white px-1.5 py-0.5 rounded-none font-medium">
                              {item.style}
                            </span>
                          )}
                          <div className="flex items-center gap-1">
                            <span
                              className="w-2.5 h-2.5 rounded-full inline-block border border-white/30 shrink-0"
                      ...
                      <div className="flex items-center justify-between pt-2">
                        <div className="flex items-center border border-white/30 rounded-none bg-[#B84E99] text-white">
                          <button
                        ...
                        <div className="text-right">
                          ...
                          {item.quantity > 1 && (
                            <span className="block text-[10px] text-white/70 tabular-nums">
              ...
              <div className="p-4 sm:p-5 border-t border-white/20 bg-[#B84E99] space-y-3 text-white">
                ...
                <div className="space-y-2 pt-1">
                  <button
                    ...
                    className="w-full py-3.5 bg-[#2D143D] hover:bg-[#1A0924] active:bg-[#2D143D] text-white text-xs uppercase tracking-[0.14em] font-bold transition-all duration-200 flex items-center justify-center gap-2.5 rounded-none active:scale-[0.99] group cursor-pointer shadow-lg border border-white/20"
                  >
                    <svg
