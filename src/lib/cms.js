...
export const DEFAULT_CONTENT = {
  ...
  story_page: {
    ...
    founders_names: 'Kamarunnisa & Rafique',
    ...
    founders_bio: 'For Kamarunnisa K A and Rafique M U, abayas are more than just garments—they are an expression of pride, grace, and tradition. With years of dedication to Islamic fashion, they set out to make timeless, modern designs reachable to every woman. By combining premium craftsmanship with honest, reasonable pricing, they continue to inspire confidence and bring elegant modest fashion into everyday life.',
